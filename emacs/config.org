...
#+begin_src emacs-lisp
  ...
  ;; This ensures org version consistency
...
(use-package org-roam
  :custom
  (org-roam-directory "~/Github/rivendell")  ;; Change this to your preferred location
...
(use-package lsp-mode
  :hook ((python-ts-mode . lsp-deferred)   ;; Enable for Python
         (python-mode . lsp-deferred))     ;; Fallback for non-ts mode
